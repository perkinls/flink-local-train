package com.lp.java.demo.commons.typeinfo;
 ...
 * @author li.pan
 * @version 1.0.0
 * @title Flink 类型TypeInformation
 * @createTime 2021年03月26日 20:28:00
 * <p>
 * https://flink-learning.org.cn/developers/introduction-to-type-and-serialization-mechanisms/
 * </p>
 */
public class TypeInfoFactoryTest {
    ...
    public void testSimpleType() {
        TypeInformation<?> typeInfo1 = TypeExtractor.createTypeInfo(IntLike.class);
        assertEquals(INT_TYPE_INFO, typeInfo1);

        TypeInformation<?> typeInfo2 = TypeExtractor.getForClass(IntLike.class);
        assertEquals(INT_TYPE_INFO, typeInfo2);

        TypeInformation<?> typeInfo3 = TypeExtractor.getForObject(new IntLike());
        assertEquals(INT_TYPE_INFO, typeInfo3);
    }
