...
object KafkaProducer {
  ...
  def sendMsgString(producer: Producer[String, String]): Unit = {
    val msg = String.valueOf(random.nextInt(100))
    println("发送到kafak数据:  " + msg)

    val producerRecord = new ProducerRecord[String, String]("fk_string_topic", msg)
  ...
  /**
    ...
    * @param producer
    */
  def sendMsgJson(producer: Producer[String, String]): Unit = {
